...
#define MTL_RXQ_DMA_Q0DDMACH		BIT(4)
...
#define GMAC_VLAN_TAG_CTRL_OFS_MASK	GENMASK(7, 2)

#define GMAC_VLAN_TAG_DATA		0x00000054
#define GMAC_VLAN_TAG_FILTER_VID	GENMASK(11, 0)
#define GMAC_VLAN_TAG_FILTER_VEN	BIT(16)
#define GMAC_VLAN_TAG_FILTER_ETV	BIT(17)
#define GMAC_VLAN_TAG_FILTER_DMACHEN		BIT(24)
#define GMAC_VLAN_TAG_FILTER_DMACHN_MASK	GENMASK(26, 25)
#define GMAC_VLAN_TAG_FILTER_DMACHN_SHIFT	25
#define GMAC_VLAN_TAG_FILTER_DMACHN		1
