...
enum wlfw_cnss_driver_mode_enum_v01 {
...
enum wlfw_cnss_cal_temp_id_enum_v01 {
...
enum wlfw_cnss_pipedir_enum_v01 {
...
enum wlfw_cnss_mem_type_enum_v01 {
...
enum wlfw_cnss_qdss_trace_mode_enum_v01 {
...
enum wlfw_cnss_wfc_media_quality_v01 {
...
enum wlfw_cnss_soc_wake_enum_v01 {
...
enum wlfw_cnss_host_build_type_v01 {
...
enum wlfw_cnss_qmi_param_value_v01 {
...
enum wlfw_cnss_rd_card_chain_cap_v01 {
...
enum wlfw_cnss_pcie_gen_speed_v01 {
...
enum wlfw_cnss_power_save_mode_v01 {
...
enum wlfw_cnss_m3_segment_type_v01 {
...
struct wlfw_cnss_ce_tgt_pipe_cfg_s_v01 {
	u32 pipe_num;
	enum wlfw_cnss_pipedir_enum_v01 pipe_dir;
	u32 nentries;
	u32 nbytes_max;
	u32 flags;
};

struct wlfw_cnss_ce_svc_pipe_cfg_s_v01 {
	u32 service_id;
	enum wlfw_cnss_pipedir_enum_v01 pipe_dir;
	u32 pipe_num;
};

struct wlfw_cnss_shadow_reg_cfg_s_v01 {
	u16 id;
	u16 offset;
};

struct wlfw_cnss_shadow_reg_v2_cfg_s_v01 {
	u32 addr;
};

struct wlfw_cnss_rri_over_ddr_cfg_s_v01 {
	u32 base_addr_low;
	u32 base_addr_high;
};

struct wlfw_cnss_msi_cfg_s_v01 {
	u16 ce_id;
	u16 msi_vector;
};

struct wlfw_cnss_memory_region_info_s_v01 {
	u64 region_addr;
	u32 size;
	u8 secure_flag;
};

struct wlfw_cnss_mem_cfg_s_v01 {
	u64 offset;
	u32 size;
	u8 secure_flag;
};

struct wlfw_cnss_mem_seg_s_v01 {
	u32 size;
	enum wlfw_cnss_mem_type_enum_v01 type;
	u32 mem_cfg_len;
	struct wlfw_cnss_mem_cfg_s_v01 mem_cfg[QMI_WLFW_MAX_NUM_MEM_CFG_V01];
};

struct wlfw_cnss_mem_seg_resp_s_v01 {
	u64 addr;
	u32 size;
	enum wlfw_cnss_mem_type_enum_v01 type;
	u8 restore;
...
struct wlfw_cnss_rf_chip_info_s_v01 {
	u32 chip_id;
	u32 chip_family;
};

struct wlfw_cnss_rf_board_info_s_v01 {
	u32 board_id;
};

struct wlfw_cnss_soc_info_s_v01 {
	u32 soc_id;
};

struct wlfw_cnss_fw_version_info_s_v01 {
	u32 fw_version;
	char fw_build_timestamp[QMI_WLFW_MAX_TIMESTAMP_LEN_V01 + 1];
};

struct wlfw_cnss_host_ddr_range_s_v01 {
	u64 start;
	u64 size;
};

struct wlfw_cnss_m3_segment_info_s_v01 {
	enum wlfw_cnss_m3_segment_type_v01 type;
	u64 addr;
	u64 size;
	char name[QMI_WLFW_MAX_STR_LEN_V01 + 1];
};

struct wlfw_cnss_dev_mem_info_s_v01 {
	u64 start;
	u64 size;
};

struct wlfw_cnss_ind_register_req_msg_v01 {
...
extern struct qmi_elem_info wlfw_cnss_ind_register_req_msg_v01_ei[];

struct wlfw_cnss_ind_register_resp_msg_v01 {
	struct qmi_response_type_v01 resp;
	u8 fw_status_valid;
	u64 fw_status;
};
#define WLFW_IND_REGISTER_RESP_MSG_V01_MAX_MSG_LEN 18
extern struct qmi_elem_info wlfw_cnss_ind_register_resp_msg_v01_ei[];

struct wlfw_cnss_fw_ready_ind_msg_v01 {
	char placeholder;
};
#define WLFW_FW_READY_IND_MSG_V01_MAX_MSG_LEN 0
extern struct qmi_elem_info wlfw_cnss_fw_ready_ind_msg_v01_ei[];

struct wlfw_cnss_msa_ready_ind_msg_v01 {
...
extern struct qmi_elem_info wlfw_cnss_msa_ready_ind_msg_v01_ei[];

struct wlfw_cnss_pin_connect_result_ind_msg_v01 {
...
extern struct qmi_elem_info wlfw_cnss_pin_connect_result_ind_msg_v01_ei[];

struct wlfw_cnss_wlan_mode_req_msg_v01 {
	enum wlfw_cnss_driver_mode_enum_v01 mode;
	u8 hw_debug_valid;
	u8 hw_debug;
};
#define WLFW_WLAN_MODE_REQ_MSG_V01_MAX_MSG_LEN 11
extern struct qmi_elem_info wlfw_cnss_wlan_mode_req_msg_v01_ei[];

struct wlfw_cnss_wlan_mode_resp_msg_v01 {
	struct qmi_response_type_v01 resp;
};
#define WLFW_WLAN_MODE_RESP_MSG_V01_MAX_MSG_LEN 7
extern struct qmi_elem_info wlfw_cnss_wlan_mode_resp_msg_v01_ei[];

struct wlfw_cnss_wlan_cfg_req_msg_v01 {
	u8 host_version_valid;
	char host_version[QMI_WLFW_MAX_STR_LEN_V01 + 1];
	u8 tgt_cfg_valid;
	u32 tgt_cfg_len;
	struct wlfw_cnss_ce_tgt_pipe_cfg_s_v01 tgt_cfg[QMI_WLFW_MAX_NUM_CE_V01];
	u8 svc_cfg_valid;
	u32 svc_cfg_len;
	struct wlfw_cnss_ce_svc_pipe_cfg_s_v01 svc_cfg[QMI_WLFW_MAX_NUM_SVC_V01];
	u8 shadow_reg_valid;
	u32 shadow_reg_len;
	struct wlfw_cnss_shadow_reg_cfg_s_v01
	...
	struct wlfw_cnss_rri_over_ddr_cfg_s_v01 rri_over_ddr_cfg;
	u8 msi_cfg_valid;
	u32 msi_cfg_len;
	struct wlfw_cnss_msi_cfg_s_v01 msi_cfg[QMI_WLFW_MAX_NUM_CE_V01];
};
#define WLFW_WLAN_CFG_REQ_MSG_V01_MAX_MSG_LEN 866
extern struct qmi_elem_info wlfw_cnss_wlan_cfg_req_msg_v01_ei[];

struct wlfw_cnss_wlan_cfg_resp_msg_v01 {
	struct qmi_response_type_v01 resp;
};
#define WLFW_WLAN_CFG_RESP_MSG_V01_MAX_MSG_LEN 7
extern struct qmi_elem_info wlfw_cnss_wlan_cfg_resp_msg_v01_ei[];

struct wlfw_cnss_cap_req_msg_v01 {
	char placeholder;
};
#define WLFW_CAP_REQ_MSG_V01_MAX_MSG_LEN 0
extern struct qmi_elem_info wlfw_cnss_cap_req_msg_v01_ei[];

struct wlfw_cnss_cap_resp_msg_v01 {
	struct qmi_response_type_v01 resp;
	u8 chip_info_valid;
	struct wlfw_cnss_rf_chip_info_s_v01 chip_info;
	u8 board_info_valid;
	struct wlfw_cnss_rf_board_info_s_v01 board_info;
	u8 soc_info_valid;
	struct wlfw_cnss_soc_info_s_v01 soc_info;
	u8 fw_version_info_valid;
	struct wlfw_cnss_fw_version_info_s_v01 fw_version_info;
	...
	enum wlfw_cnss_rd_card_chain_cap_v01 rd_card_chain_cap;
...
extern struct qmi_elem_info wlfw_cnss_cap_resp_msg_v01_ei[];

struct wlfw_cnss_bdf_download_req_msg_v01 {
	u8 valid;
	u8 file_id_valid;
	enum wlfw_cnss_cal_temp_id_enum_v01 file_id;
	u8 total_size_valid;
	u32 total_size;
	u8 seg_id_valid;
	u32 seg_id;
...
extern struct qmi_elem_info wlfw_cnss_bdf_download_req_msg_v01_ei[];

struct wlfw_cnss_bdf_download_resp_msg_v01 {
	struct qmi_response_type_v01 resp;
...
extern struct qmi_elem_info wlfw_cnss_bdf_download_resp_msg_v01_ei[];

struct wlfw_cnss_cal_report_req_msg_v01 {
	u32 meta_data_len;
	enum wlfw_cnss_cal_temp_id_enum_v01 meta_data[QMI_WLFW_MAX_NUM_CAL_V01];
...
extern struct qmi_elem_info wlfw_cnss_cal_report_req_msg_v01_ei[];

struct wlfw_cnss_cal_report_resp_msg_v01 {
	struct qmi_response_type_v01 resp;
};
#define WLFW_CAL_REPORT_RESP_MSG_V01_MAX_MSG_LEN 7
extern struct qmi_elem_info wlfw_cnss_cal_report_resp_msg_v01_ei[];

struct wlfw_cnss_initiate_cal_download_ind_msg_v01 {
	enum wlfw_cnss_cal_temp_id_enum_v01 cal_id;
	u8 total_size_valid;
	u32 total_size;
...
extern struct qmi_elem_info wlfw_cnss_initiate_cal_download_ind_msg_v01_ei[];

struct wlfw_cnss_cal_download_req_msg_v01 {
	u8 valid;
	u8 file_id_valid;
	enum wlfw_cnss_cal_temp_id_enum_v01 file_id;
	u8 total_size_valid;
...
extern struct qmi_elem_info wlfw_cnss_cal_download_req_msg_v01_ei[];

struct wlfw_cnss_cal_download_resp_msg_v01 {
	struct qmi_response_type_v01 resp;
};
#define WLFW_CAL_DOWNLOAD_RESP_MSG_V01_MAX_MSG_LEN 7
extern struct qmi_elem_info wlfw_cnss_cal_download_resp_msg_v01_ei[];

struct wlfw_cnss_initiate_cal_update_ind_msg_v01 {
	enum wlfw_cnss_cal_temp_id_enum_v01 cal_id;
	u32 total_size;
	u8 cal_data_location_valid;
	u32 cal_data_location;
...
extern struct qmi_elem_info wlfw_cnss_initiate_cal_update_ind_msg_v01_ei[];

struct wlfw_cnss_cal_update_req_msg_v01 {
	enum wlfw_cnss_cal_temp_id_enum_v01 cal_id;
	u32 seg_id;
};
#define WLFW_CAL_UPDATE_REQ_MSG_V01_MAX_MSG_LEN 14
extern struct qmi_elem_info wlfw_cnss_cal_update_req_msg_v01_ei[];

struct wlfw_cnss_cal_update_resp_msg_v01 {
	struct qmi_response_type_v01 resp;
	u8 file_id_valid;
	enum wlfw_cnss_cal_temp_id_enum_v01 file_id;
	u8 total_size_valid;
...
extern struct qmi_elem_info wlfw_cnss_cal_update_resp_msg_v01_ei[];

struct wlfw_cnss_msa_info_req_msg_v01 {
	u64 msa_addr;
	u32 size;
};
#define WLFW_MSA_INFO_REQ_MSG_V01_MAX_MSG_LEN 18
extern struct qmi_elem_info wlfw_cnss_msa_info_req_msg_v01_ei[];

struct wlfw_cnss_msa_info_resp_msg_v01 {
	struct qmi_response_type_v01 resp;
...
extern struct qmi_elem_info wlfw_cnss_msa_info_resp_msg_v01_ei[];

struct wlfw_cnss_msa_ready_req_msg_v01 {
	char placeholder;
};
#define WLFW_MSA_READY_REQ_MSG_V01_MAX_MSG_LEN 0
extern struct qmi_elem_info wlfw_cnss_msa_ready_req_msg_v01_ei[];

struct wlfw_cnss_msa_ready_resp_msg_v01 {
	struct qmi_response_type_v01 resp;
};
#define WLFW_MSA_READY_RESP_MSG_V01_MAX_MSG_LEN 7
extern struct qmi_elem_info wlfw_cnss_msa_ready_resp_msg_v01_ei[];

struct wlfw_cnss_ini_req_msg_v01 {
	u8 enablefwlog_valid;
	u8 enablefwlog;
};
#define WLFW_INI_REQ_MSG_V01_MAX_MSG_LEN 4
extern struct qmi_elem_info wlfw_cnss_ini_req_msg_v01_ei[];

struct wlfw_cnss_ini_resp_msg_v01 {
	struct qmi_response_type_v01 resp;
};
#define WLFW_INI_RESP_MSG_V01_MAX_MSG_LEN 7
extern struct qmi_elem_info wlfw_cnss_ini_resp_msg_v01_ei[];

struct wlfw_cnss_athdiag_read_req_msg_v01 {
	u32 offset;
	u32 mem_type;
	u32 data_len;
};
#define WLFW_ATHDIAG_READ_REQ_MSG_V01_MAX_MSG_LEN 21
extern struct qmi_elem_info wlfw_cnss_athdiag_read_req_msg_v01_ei[];

struct wlfw_cnss_athdiag_read_resp_msg_v01 {
	struct qmi_response_type_v01 resp;
	u8 data_valid;
	u32 data_len;
...
extern struct qmi_elem_info wlfw_cnss_athdiag_read_resp_msg_v01_ei[];

struct wlfw_cnss_athdiag_write_req_msg_v01 {
	u32 offset;
	u32 mem_type;
	u32 data_len;
	u8 data[QMI_WLFW_MAX_ATHDIAG_DATA_SIZE_V01];
...
extern struct qmi_elem_info wlfw_cnss_athdiag_write_req_msg_v01_ei[];

struct wlfw_cnss_athdiag_write_resp_msg_v01 {
	struct qmi_response_type_v01 resp;
};
#define WLFW_ATHDIAG_WRITE_RESP_MSG_V01_MAX_MSG_LEN 7
extern struct qmi_elem_info wlfw_cnss_athdiag_write_resp_msg_v01_ei[];

struct wlfw_cnss_vbatt_req_msg_v01 {
	u64 voltage_uv;
};
#define WLFW_VBATT_REQ_MSG_V01_MAX_MSG_LEN 11
extern struct qmi_elem_info wlfw_cnss_vbatt_req_msg_v01_ei[];

struct wlfw_cnss_vbatt_resp_msg_v01 {
	struct qmi_response_type_v01 resp;
};
#define WLFW_VBATT_RESP_MSG_V01_MAX_MSG_LEN 7
extern struct qmi_elem_info wlfw_cnss_vbatt_resp_msg_v01_ei[];

struct wlfw_cnss_mac_addr_req_msg_v01 {
	u8 mac_addr_valid;
	u8 mac_addr[QMI_WLFW_MAC_ADDR_SIZE_V01];
};
#define WLFW_MAC_ADDR_REQ_MSG_V01_MAX_MSG_LEN 9
extern struct qmi_elem_info wlfw_cnss_mac_addr_req_msg_v01_ei[];

struct wlfw_cnss_mac_addr_resp_msg_v01 {
	struct qmi_response_type_v01 resp;
};
#define WLFW_MAC_ADDR_RESP_MSG_V01_MAX_MSG_LEN 7
extern struct qmi_elem_info wlfw_cnss_mac_addr_resp_msg_v01_ei[];

struct wlfw_cnss_host_cap_req_msg_v01 {
	...
	enum wlfw_cnss_host_build_type_v01 host_build_type;
};
#define WLFW_HOST_CAP_REQ_MSG_V01_MAX_MSG_LEN 319
extern struct qmi_elem_info wlfw_cnss_host_cap_req_msg_v01_ei[];

struct wlfw_cnss_host_cap_resp_msg_v01 {
	struct qmi_response_type_v01 resp;
};
#define WLFW_HOST_CAP_RESP_MSG_V01_MAX_MSG_LEN 7
extern struct qmi_elem_info wlfw_cnss_host_cap_resp_msg_v01_ei[];

struct wlfw_cnss_request_mem_ind_msg_v01 {
	u32 mem_seg_len;
	struct wlfw_cnss_mem_seg_s_v01 mem_seg[QMI_WLFW_MAX_NUM_MEM_SEG_V01];
};
#define WLFW_REQUEST_MEM_IND_MSG_V01_MAX_MSG_LEN 1124
extern struct qmi_elem_info wlfw_cnss_request_mem_ind_msg_v01_ei[];

struct wlfw_cnss_respond_mem_req_msg_v01 {
	u32 mem_seg_len;
	struct wlfw_cnss_mem_seg_resp_s_v01 mem_seg[QMI_WLFW_MAX_NUM_MEM_SEG_V01];
};
#define WLFW_RESPOND_MEM_REQ_MSG_V01_MAX_MSG_LEN 548
extern struct qmi_elem_info wlfw_cnss_respond_mem_req_msg_v01_ei[];

struct wlfw_cnss_respond_mem_resp_msg_v01 {
	struct qmi_response_type_v01 resp;
};
#define WLFW_RESPOND_MEM_RESP_MSG_V01_MAX_MSG_LEN 7
extern struct qmi_elem_info wlfw_cnss_respond_mem_resp_msg_v01_ei[];

struct wlfw_cnss_fw_mem_ready_ind_msg_v01 {
	char placeholder;
};
#define WLFW_FW_MEM_READY_IND_MSG_V01_MAX_MSG_LEN 0
extern struct qmi_elem_info wlfw_cnss_fw_mem_ready_ind_msg_v01_ei[];

struct wlfw_cnss_fw_init_done_ind_msg_v01 {
	u8 hang_data_addr_offset_valid;
	u32 hang_data_addr_offset;
	u8 hang_data_length_valid;
	u16 hang_data_length;
...
extern struct qmi_elem_info wlfw_cnss_fw_init_done_ind_msg_v01_ei[];

struct wlfw_cnss_rejuvenate_ind_msg_v01 {
...
extern struct qmi_elem_info wlfw_cnss_rejuvenate_ind_msg_v01_ei[];

struct wlfw_cnss_rejuvenate_ack_req_msg_v01 {
	char placeholder;
};
#define WLFW_REJUVENATE_ACK_REQ_MSG_V01_MAX_MSG_LEN 0
extern struct qmi_elem_info wlfw_cnss_rejuvenate_ack_req_msg_v01_ei[];

struct wlfw_cnss_rejuvenate_ack_resp_msg_v01 {
	struct qmi_response_type_v01 resp;
};
#define WLFW_REJUVENATE_ACK_RESP_MSG_V01_MAX_MSG_LEN 7
extern struct qmi_elem_info wlfw_cnss_rejuvenate_ack_resp_msg_v01_ei[];

struct wlfw_cnss_dynamic_feature_mask_req_msg_v01 {
	u8 mask_valid;
	u64 mask;
};
#define WLFW_DYNAMIC_FEATURE_MASK_REQ_MSG_V01_MAX_MSG_LEN 11
extern struct qmi_elem_info wlfw_cnss_dynamic_feature_mask_req_msg_v01_ei[];

struct wlfw_cnss_dynamic_feature_mask_resp_msg_v01 {
	struct qmi_response_type_v01 resp;
	u8 prev_mask_valid;
	u64 prev_mask;
	u8 curr_mask_valid;
...
extern struct qmi_elem_info wlfw_cnss_dynamic_feature_mask_resp_msg_v01_ei[];

struct wlfw_cnss_m3_info_req_msg_v01 {
	u64 addr;
	u32 size;
};
#define WLFW_M3_INFO_REQ_MSG_V01_MAX_MSG_LEN 18
extern struct qmi_elem_info wlfw_cnss_m3_info_req_msg_v01_ei[];

struct wlfw_cnss_m3_info_resp_msg_v01 {
	struct qmi_response_type_v01 resp;
};
#define WLFW_M3_INFO_RESP_MSG_V01_MAX_MSG_LEN 7
extern struct qmi_elem_info wlfw_cnss_m3_info_resp_msg_v01_ei[];

struct wlfw_cnss_xo_cal_ind_msg_v01 {
	u8 xo_cal_data;
};
#define WLFW_XO_CAL_IND_MSG_V01_MAX_MSG_LEN 4
extern struct qmi_elem_info wlfw_cnss_xo_cal_ind_msg_v01_ei[];

struct wlfw_cnss_cal_done_ind_msg_v01 {
	char placeholder;
};
#define WLFW_CAL_DONE_IND_MSG_V01_MAX_MSG_LEN 0
extern struct qmi_elem_info wlfw_cnss_cal_done_ind_msg_v01_ei[];

struct wlfw_cnss_qdss_trace_req_mem_ind_msg_v01 {
	u32 mem_seg_len;
	struct wlfw_cnss_mem_seg_s_v01 mem_seg[QMI_WLFW_MAX_NUM_MEM_SEG_V01];
};
#define WLFW_QDSS_TRACE_REQ_MEM_IND_MSG_V01_MAX_MSG_LEN 1124
extern struct qmi_elem_info wlfw_cnss_qdss_trace_req_mem_ind_msg_v01_ei[];

struct wlfw_cnss_qdss_trace_mem_info_req_msg_v01 {
	u32 mem_seg_len;
	struct wlfw_cnss_mem_seg_resp_s_v01 mem_seg[QMI_WLFW_MAX_NUM_MEM_SEG_V01];
};
#define WLFW_QDSS_TRACE_MEM_INFO_REQ_MSG_V01_MAX_MSG_LEN 548
extern struct qmi_elem_info wlfw_cnss_qdss_trace_mem_info_req_msg_v01_ei[];

struct wlfw_cnss_qdss_trace_mem_info_resp_msg_v01 {
	struct qmi_response_type_v01 resp;
};
#define WLFW_QDSS_TRACE_MEM_INFO_RESP_MSG_V01_MAX_MSG_LEN 7
extern struct qmi_elem_info wlfw_cnss_qdss_trace_mem_info_resp_msg_v01_ei[];

struct wlfw_cnss_qdss_trace_save_ind_msg_v01 {
	u32 source;
	u32 total_size;
	u8 mem_seg_valid;
	u32 mem_seg_len;
...
extern struct qmi_elem_info wlfw_cnss_qdss_trace_save_ind_msg_v01_ei[];

struct wlfw_cnss_qdss_trace_data_req_msg_v01 {
	u32 seg_id;
};
#define WLFW_QDSS_TRACE_DATA_REQ_MSG_V01_MAX_MSG_LEN 7
extern struct qmi_elem_info wlfw_cnss_qdss_trace_data_req_msg_v01_ei[];

struct wlfw_cnss_qdss_trace_data_resp_msg_v01 {
	struct qmi_response_type_v01 resp;
	u8 total_size_valid;
	u32 total_size;
	u8 seg_id_valid;
...
extern struct qmi_elem_info wlfw_cnss_qdss_trace_data_resp_msg_v01_ei[];

struct wlfw_cnss_qdss_trace_config_download_req_msg_v01 {
	u8 total_size_valid;
	u32 total_size;
	u8 seg_id_valid;
	u32 seg_id;
...
extern struct qmi_elem_info wlfw_cnss_qdss_trace_config_download_req_msg_v01_ei[];

struct wlfw_cnss_qdss_trace_config_download_resp_msg_v01 {
	struct qmi_response_type_v01 resp;
};
#define WLFW_QDSS_TRACE_CONFIG_DOWNLOAD_RESP_MSG_V01_MAX_MSG_LEN 7
extern struct qmi_elem_info wlfw_cnss_qdss_trace_config_download_resp_msg_v01_ei[];

struct wlfw_cnss_qdss_trace_mode_req_msg_v01 {
	u8 mode_valid;
	enum wlfw_cnss_qdss_trace_mode_enum_v01 mode;
	u8 option_valid;
	u64 option;
	u8 hw_trc_disable_override_valid;
	enum wlfw_cnss_qmi_param_value_v01 hw_trc_disable_override;
};
#define WLFW_QDSS_TRACE_MODE_REQ_MSG_V01_MAX_MSG_LEN 25
extern struct qmi_elem_info wlfw_cnss_qdss_trace_mode_req_msg_v01_ei[];

struct wlfw_cnss_qdss_trace_mode_resp_msg_v01 {
	struct qmi_response_type_v01 resp;
};
#define WLFW_QDSS_TRACE_MODE_RESP_MSG_V01_MAX_MSG_LEN 7
extern struct qmi_elem_info wlfw_cnss_qdss_trace_mode_resp_msg_v01_ei[];

struct wlfw_cnss_qdss_trace_free_ind_msg_v01 {
	u8 mem_seg_valid;
	u32 mem_seg_len;
	struct wlfw_cnss_mem_seg_resp_s_v01 mem_seg[QMI_WLFW_MAX_NUM_MEM_SEG_V01];
};
#define WLFW_QDSS_TRACE_FREE_IND_MSG_V01_MAX_MSG_LEN 548
extern struct qmi_elem_info wlfw_cnss_qdss_trace_free_ind_msg_v01_ei[];

struct wlfw_cnss_shutdown_req_msg_v01 {
	u8 shutdown_valid;
	u8 shutdown;
};
#define WLFW_SHUTDOWN_REQ_MSG_V01_MAX_MSG_LEN 4
extern struct qmi_elem_info wlfw_cnss_shutdown_req_msg_v01_ei[];

struct wlfw_cnss_shutdown_resp_msg_v01 {
	struct qmi_response_type_v01 resp;
};
#define WLFW_SHUTDOWN_RESP_MSG_V01_MAX_MSG_LEN 7
extern struct qmi_elem_info wlfw_cnss_shutdown_resp_msg_v01_ei[];

struct wlfw_cnss_antenna_switch_req_msg_v01 {
	char placeholder;
};
#define WLFW_ANTENNA_SWITCH_REQ_MSG_V01_MAX_MSG_LEN 0
extern struct qmi_elem_info wlfw_cnss_antenna_switch_req_msg_v01_ei[];

struct wlfw_cnss_antenna_switch_resp_msg_v01 {
	struct qmi_response_type_v01 resp;
	u8 antenna_valid;
	u64 antenna;
};
#define WLFW_ANTENNA_SWITCH_RESP_MSG_V01_MAX_MSG_LEN 18
extern struct qmi_elem_info wlfw_cnss_antenna_switch_resp_msg_v01_ei[];

struct wlfw_cnss_antenna_grant_req_msg_v01 {
	u8 grant_valid;
	u64 grant;
};
#define WLFW_ANTENNA_GRANT_REQ_MSG_V01_MAX_MSG_LEN 11
extern struct qmi_elem_info wlfw_cnss_antenna_grant_req_msg_v01_ei[];

struct wlfw_cnss_antenna_grant_resp_msg_v01 {
	struct qmi_response_type_v01 resp;
};
#define WLFW_ANTENNA_GRANT_RESP_MSG_V01_MAX_MSG_LEN 7
extern struct qmi_elem_info wlfw_cnss_antenna_grant_resp_msg_v01_ei[];

struct wlfw_cnss_wfc_call_status_req_msg_v01 {
	...
	enum wlfw_cnss_wfc_media_quality_v01 media_quality;
};
#define WLFW_WFC_CALL_STATUS_REQ_MSG_V01_MAX_MSG_LEN 296
extern struct qmi_elem_info wlfw_cnss_wfc_call_status_req_msg_v01_ei[];

struct wlfw_cnss_wfc_call_status_resp_msg_v01 {
	struct qmi_response_type_v01 resp;
};
#define WLFW_WFC_CALL_STATUS_RESP_MSG_V01_MAX_MSG_LEN 7
extern struct qmi_elem_info wlfw_cnss_wfc_call_status_resp_msg_v01_ei[];

struct wlfw_cnss_get_info_req_msg_v01 {
	u8 type;
	u32 data_len;
	u8 data[QMI_WLFW_MAX_DATA_SIZE_V01];
};
#define WLFW_GET_INFO_REQ_MSG_V01_MAX_MSG_LEN 6153
extern struct qmi_elem_info wlfw_cnss_get_info_req_msg_v01_ei[];

struct wlfw_cnss_get_info_resp_msg_v01 {
	struct qmi_response_type_v01 resp;
};
#define WLFW_GET_INFO_RESP_MSG_V01_MAX_MSG_LEN 7
extern struct qmi_elem_info wlfw_cnss_get_info_resp_msg_v01_ei[];

struct wlfw_cnss_respond_get_info_ind_msg_v01 {
	u32 data_len;
	u8 data[QMI_WLFW_MAX_DATA_SIZE_V01];
	u8 type_valid;
	u8 type;
...
extern struct qmi_elem_info wlfw_cnss_respond_get_info_ind_msg_v01_ei[];

struct wlfw_cnss_device_info_req_msg_v01 {
	char placeholder;
};
#define WLFW_DEVICE_INFO_REQ_MSG_V01_MAX_MSG_LEN 0
extern struct qmi_elem_info wlfw_cnss_device_info_req_msg_v01_ei[];

struct wlfw_cnss_device_info_resp_msg_v01 {
	struct qmi_response_type_v01 resp;
	u8 bar_addr_valid;
	u64 bar_addr;
	u8 bar_size_valid;
...
extern struct qmi_elem_info wlfw_cnss_device_info_resp_msg_v01_ei[];

struct wlfw_cnss_m3_dump_upload_req_ind_msg_v01 {
	u32 pdev_id;
	u64 addr;
	u64 size;
};
#define WLFW_M3_DUMP_UPLOAD_REQ_IND_MSG_V01_MAX_MSG_LEN 29
extern struct qmi_elem_info wlfw_cnss_m3_dump_upload_req_ind_msg_v01_ei[];

struct wlfw_cnss_m3_dump_upload_done_req_msg_v01 {
	u32 pdev_id;
	u32 status;
};
#define WLFW_M3_DUMP_UPLOAD_DONE_REQ_MSG_V01_MAX_MSG_LEN 14
extern struct qmi_elem_info wlfw_cnss_m3_dump_upload_done_req_msg_v01_ei[];

struct wlfw_cnss_m3_dump_upload_done_resp_msg_v01 {
	struct qmi_response_type_v01 resp;
};
#define WLFW_M3_DUMP_UPLOAD_DONE_RESP_MSG_V01_MAX_MSG_LEN 7
extern struct qmi_elem_info wlfw_cnss_m3_dump_upload_done_resp_msg_v01_ei[];

struct wlfw_cnss_soc_wake_req_msg_v01 {
	u8 wake_valid;
	enum wlfw_cnss_soc_wake_enum_v01 wake;
};
#define WLFW_SOC_WAKE_REQ_MSG_V01_MAX_MSG_LEN 7
extern struct qmi_elem_info wlfw_cnss_soc_wake_req_msg_v01_ei[];

struct wlfw_cnss_soc_wake_resp_msg_v01 {
	struct qmi_response_type_v01 resp;
};
#define WLFW_SOC_WAKE_RESP_MSG_V01_MAX_MSG_LEN 7
extern struct qmi_elem_info wlfw_cnss_soc_wake_resp_msg_v01_ei[];

struct wlfw_cnss_power_save_req_msg_v01 {
	u8 power_save_mode_valid;
	enum wlfw_cnss_power_save_mode_v01 power_save_mode;
};

#define WLFW_POWER_SAVE_REQ_MSG_V01_MAX_MSG_LEN 7
extern struct qmi_elem_info wlfw_cnss_power_save_req_msg_v01_ei[];

struct wlfw_cnss_power_save_resp_msg_v01 {
	struct qmi_response_type_v01 resp;
};

#define WLFW_POWER_SAVE_RESP_MSG_V01_MAX_MSG_LEN 7
extern struct qmi_elem_info wlfw_cnss_power_save_resp_msg_v01_ei[];

struct wlfw_cnss_wfc_call_twt_config_ind_msg_v01 {
...
extern struct qmi_elem_info wlfw_cnss_wfc_call_twt_config_ind_msg_v01_ei[];

struct wlfw_cnss_qdss_mem_ready_ind_msg_v01 {
	char placeholder;
};

#define WLFW_QDSS_MEM_READY_IND_MSG_V01_MAX_MSG_LEN 0
extern struct qmi_elem_info wlfw_cnss_qdss_mem_ready_ind_msg_v01_ei[];

struct wlfw_cnss_pcie_gen_switch_req_msg_v01 {
	enum wlfw_cnss_pcie_gen_speed_v01 pcie_speed;
};

#define WLFW_PCIE_GEN_SWITCH_REQ_MSG_V01_MAX_MSG_LEN 7
extern struct qmi_elem_info wlfw_cnss_pcie_gen_switch_req_msg_v01_ei[];

struct wlfw_cnss_pcie_gen_switch_resp_msg_v01 {
	struct qmi_response_type_v01 resp;
};

#define WLFW_PCIE_GEN_SWITCH_RESP_MSG_V01_MAX_MSG_LEN 7
extern struct qmi_elem_info wlfw_cnss_pcie_gen_switch_resp_msg_v01_ei[];

struct wlfw_cnss_m3_dump_upload_segments_req_ind_msg_v01 {
	u32 pdev_id;
...
extern struct qmi_elem_info wlfw_cnss_m3_dump_upload_segments_req_ind_msg_v01_ei[];
